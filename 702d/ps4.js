...
document.getElementById("myProgress").remove();
	document.getElementById('load').innerHTML='<tr>'+
			...
			'<a href="#" id="goldhen" class="button pointer" onMouseOver="progress.innerHTML=\'GoldHen by SISTR0 for PS4 7.02 Fw\'"; onmouseout="progress.innerHTML=\'Karo Host for PS4 7.02 FW\'" onclick="toggle_payload(\'goldhen\'); return false" style="font-size:25px;text-align:center;text-shadow: 4px 4px 4px black;color:#CEC52A">GoldHen</a>&nbsp;'+
			...
			'<td class="content" >'+
 	        ...
 	        '<br><br><br><span style="text-shadow: 4px 4px 4px black;" class="yellow" >Super Special Thanks To :</span >&nbsp;&nbsp; <a style="font-size:30px;text-align:center;text-shadow: 4px 4px 4px black;color:white;">Sleirsgoevy , ChendoChap , DarkModderVC , ... </a>'+
	        '</div>'+
			'</td>'+
	        '</tr>';
